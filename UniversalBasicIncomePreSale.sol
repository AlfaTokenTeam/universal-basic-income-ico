...
import "./UniversalBasicIncome.sol";

contract UniversalBasicIncomePreSale {
    UniversalBasicIncome public token;
    address public beneficiary;
    uint public amountRaised;
    uint public bonus;

    uint constant public price = 100000000;
    uint constant public minSaleAmount = 5000000000;

    function UniversalBasicIncomePreSale(
        UniversalBasicIncome _token,
        address _beneficiary,
        uint _bonus
    ) {
        token = UniversalBasicIncome(_token);
